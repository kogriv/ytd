...
Status: Maintenance 1.1 и 1.2 — complete; Maintenance 1.3 — открыт (BL-12xx todo)  
Owner: @Ivan  
Created: 2026-05-25  
Last updated: 2026-08-31 (Maintenance 1.3 — добавлен спринт L по ревью техдолга)
...
| BL-1205 | Решение и настройка защиты ветки `main` | GAP-CR-039 | P2 | todo | S |
| BL-1206 | Решение по интеграционным тестам | GAP-CR-040 | P3 | todo | S |
| BL-1207 | Решение по JSONL и SQLite | GAP-CR-009 | P3 | todo | M |
...
- [ ] P1: BL-1201, BL-1202 — status `done`
- [ ] P2: BL-1203, BL-1204, BL-1205 — status `done`
- [ ] P3: BL-1206, BL-1207 — решения приняты и зафиксированы
- [ ] Полный `pytest` зелёный на Windows и Linux; покрытие не ниже порога
- [ ] `ruff check .` и проверка типов чисты
- [ ] CI: `test (ubuntu-latest)`, `test (windows-latest)`, `lint` зелёные
- [ ] `docs/gaps/tech_debt_2026-08-31.md`: статусы GAP-CR-035 … GAP-CR-040 и GAP-CR-009 обновлены
