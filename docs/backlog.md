...
| ID | Задача | Gap | Priority | Status | Est |
|----|--------|-----|----------|--------|-----|
| BL-1201 | Закрывать родительскую запись истории для плейлиста | GAP-CR-035 | P1 | todo | S |
| BL-1202 | Единственный читатель клавиатуры в `PauseController` | GAP-CR-036 | P1 | todo | M |
...
- **Priority:** P1 | **Status:** todo | **Estimate:** M
