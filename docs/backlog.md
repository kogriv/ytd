...
| BL-1203 | Проверка типов (mypy) в CI | GAP-CR-037 | P2 | todo | M |
| BL-1204 | Измерение покрытия тестами с порогом | GAP-CR-038 | P2 | todo | S |
...
Состояние после блока дефектов (BL-1201 + BL-1202, 2026-08-31): 127 тестов (125 passed, 2 skipped), `ruff check .` чисто. Осталось: BL-1203, BL-1204, BL-1205 (ворота качества) и BL-1206, BL-1207 (решения владельца).
...
- **Priority:** P2 | **Status:** todo | **Estimate:** M
