...
Состояние после BL-1110 (2026-08-31): остановка пользователем больше не гасится сценариями. Тесты: **119 passed, 2 skipped**. Осталось в спринте только документационное: BL-1108, BL-1109.
